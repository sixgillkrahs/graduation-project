...
function StepperIndicator({
  ...
  return (
    <div
      ...
      data-state={state}
      className={cn(
        "relative flex items-center overflow-hidden justify-center size-10 shrink-0 border-background bg-accent text-accent-foreground rounded-full text-xl  data-[state=completed]:bg-primary data-[state=completed]:text-primary-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground",
        className,
      )}
    >
            ...
            <StepperItem key={index} step={stepNum} className="flex-1">
              <StepperTrigger className="w-full flex flex-col items-center gap-2">
                ...
                <div className="flex flex-col items-center text-center gap-0.5">
                  {step.title && <StepperTitle>{step.title}</StepperTitle>}
                  {step.description && (
