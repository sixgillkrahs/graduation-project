...
const PropertyResultsMap = ({
  ...
  if (!items.length) {
    return (
      <div className="flex h-[540px] items-center justify-center rounded-[28px] border border-dashed border-stone-300 bg-stone-50 p-6 text-center text-stone-500 md:h-[520px] xl:h-[calc(100vh-10rem)] xl:max-h-[720px]">
  ...
  return (
    <div className="relative h-[540px]  overflow-hidden rounded-[28px] border border-stone-200 bg-white shadow-sm">
      <MapGL
        ref={mapRef}
        {...viewState}
